...
6. При необходимости укажите в `RequestRecipients` дополнительных получателей новых заявок. Всех администраторов из `AdminTelegramIds` добавлять туда не нужно.
